...
java.util.HashMap.addEntry(HashMap.java:808)
 .next
   ...
   (b)  java.util.HashMap.put(HashMap.java:405)
        java.util.HashMap.putForNullKey(HashMap.java:424)
        java.util.HashMap.transfer(HashMap.java:522)
        java.util.HashMap.transfer(HashMap.java:524)
 .value
   (a)  java.util.HashMap.put(HashMap.java:409) [4]
        java.util.HashMap.putForNullKey(HashMap.java:427) [4]
   (b)  java.util.HashMap.put(HashMap.java:408) [2]
        java.util.HashMap.put(HashMap.java:409) [2]
        java.util.HashMap.putForNullKey(HashMap.java:426) [2]
        java.util.HashMap.putForNullKey(HashMap.java:427) [2]
java.util.HashMap.addEntry(HashMap.java:808)
 .hash
 ...
 .next
   ...
   (b)  java.util.HashMap.put(HashMap.java:405) [2]
        java.util.HashMap.putForNullKey(HashMap.java:424) [2]
        java.util.HashMap.transfer(HashMap.java:522) [2]
 ...
 .value
   (a)  java.util.HashMap$Entry.<init>(HashMap$Entry.java:736) [4]
        ...
        java.util.HashMap.putForNullKey(HashMap.java:427) [4]
   (b)  java.util.HashMap.put(HashMap.java:408) [3]
        java.util.HashMap.put(HashMap.java:409) [3]
        java.util.HashMap.putForNullKey(HashMap.java:426) [3]
        java.util.HashMap.putForNullKey(HashMap.java:427) [3]
