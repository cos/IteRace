  ...
  try {
    ...
    do {
      ...
      l match {
        ...
        case s: String if s.startsWith("cha") => println(iteRace.pa.getClassHierarchy().asScala.find({ case c => c.toString.contains(s.substring(4)) }))
    ...
    case e: ConfigException.Missing => System.err.println(e.getMessage())
  }
}